...
const RoomPage = () => {
  ...
  return (
    <main className="flex flex-col h-screen max-h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4  [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-track]:bg-gray-100 [scrollbar-width:thin][scrollbar-color:var(--color-gray-300)_var(--color-gray-100)]"></div>
